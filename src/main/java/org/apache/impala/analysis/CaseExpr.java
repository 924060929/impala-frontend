...
public class CaseExpr extends Expr {
  ...
  public void analyze(Analyzer analyzer) throws AnalysisException {
    ...
    int loopStart;
    Expr caseExpr = null;
    // Set loop startPosition, and initialize returnType as type of castExpr.
    if (hasCaseExpr_) {
      loopStart = 1;
      castCharToString(0);
    ...
    for (int i = loopStart; i < loopEnd; i += 2) {
      ...
      if (hasCaseExpr_) {
        ...
        // and all when exprs seen so far. We will add casts to them at the very endPosition.
      ...
      // We will add casts to them at the very endPosition.
