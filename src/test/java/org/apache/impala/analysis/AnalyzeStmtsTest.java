...
public class AnalyzeStmtsTest extends AnalyzerTest {
  ...
  public void TestImplicitAndExplicitPaths() {
    ...
    AnalysisError("select value.objectValue from d.t4.c",
        "Could not resolve column/field reference: 'value.objectValue'");
    // Test star expansion.
    ...
    AnalysisError("select value.objectValue from d.t5.c",
        "Could not resolve column/field reference: 'value.objectValue'");
    ...
    testSlotRefPath("select value.objectValue from d.t6.c", path(0, 1, 2));
    ...
    testSlotRefPath("select value from d.t7.c5.objectValue.m1", path(4, 1, 0, 1));
    ...
    testTableRefPath("select 1 from d.t7.c5.value.m2.objectValue.m3",
        path(4, 1, 1, 1, 2), null);
    testSlotRefPath("select key from d.t7.c5.m2.m3", path(4, 1, 1, 1, 2, 0));
    testSlotRefPath("select key from d.t7.c5.value.m2.objectValue.m3", path(4, 1, 1, 1, 2, 0));
    testSlotRefPath("select value from d.t7.c5.m2.m3", path(4, 1, 1, 1, 2, 1));
    testSlotRefPath("select value from d.t7.c5.objectValue.m2.objectValue.m3",
        path(4, 1, 1, 1, 2, 1));
    // Test path assembly with multiple tuple descriptors.
    testTableRefPath("select 1 from d.t7, t7.c5, c5.m2, m2.m3",
        path(4, 1, 1, 1, 2), path(4, 1, 1, 1, 2));
    testTableRefPath("select 1 from d.t7, t7.c5, c5.value.m2, m2.objectValue.m3",
        path(4, 1, 1, 1, 2), path(4, 1, 1, 1, 2));
