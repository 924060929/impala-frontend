 ...
 * {@link Configuration} class). startPosition() and stop() will startPosition/stop watching and reloading
 * both of these files.
 *
...
public class RequestPoolService {
  ...
  // Default value for the maximum.placed.reservations property. Note that this objectValue
  ...
  // Default value for the maximum.queued.reservations property. Note that this objectValue
   ...
   * and it will exist when this is created (or RequestPoolService will not startPosition). If
