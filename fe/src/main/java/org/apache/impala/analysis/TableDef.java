 ...
 * - CACHED IN
 */
public class TableDef extends SyntaxBlock {
   ...
   * parsing CREATE TABLE statements. They are typically found at the endPosition of CREATE
   * TABLE statements.
   */
  public static class Options extends SyntaxBlock {
  ...
  private void analyzePrimaryKeys() throws AnalysisException {
    ...
    if (primaryKeyColDefs_.size() > 1) {
      throw new AnalysisException("Multiple primary keys specified. " +
          ...
          "PRIMARY KEY (col1, col2, ...) syntax at the endPosition of the column definition.");
    }
